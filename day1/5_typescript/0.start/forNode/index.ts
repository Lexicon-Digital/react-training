...
arrayOfFruits.forEach((fruit) => console.log(fruit.toUpperCase()));
const wordLengths = arrayOfFruits.map((fruit) => fruit.length);
console.log(wordLengths.join(","));

const totalNumberOfLetters = arrayOfFruits.reduce(
